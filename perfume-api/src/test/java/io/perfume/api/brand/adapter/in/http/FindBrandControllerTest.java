...
public class FindBrandControllerTest {
    ...
    void get() throws Exception {
        // given
        String name = "CHANEL";
        String story = "샤넬 향수는 특별한 향과 함께 있는 그대로의 모습을 드러내는 작품입니다. 특별한 시리즈를 통해 샤넬 향수에 관련된 노하우와 전문 기술, 창의성을 끊임없이 추구하는 샤넬의 여정을 확인해 보세요.";
                ...
                .andDo(
                        document("get-brand",
                                responseFields(
                                        ...
                                        fieldWithPath("thumbnailUrl").type(JsonFieldType.STRING).description("브랜드 썸네일 이미지")
                                )));
    }
}

...
class PerfumePersistenceAdapterTest {
  @Autowired private PerfumePersistenceAdapter perfumePersistenceAdapter;
  ...
  void save() {
    ...
    assertEquals(
        perfume.getNotePyramidIds().getTopNoteIds(),
        savedPerfume.getNotePyramidIds().getTopNoteIds());
    assertEquals(
        perfume.getNotePyramidIds().getMiddleNoteIds(),
        savedPerfume.getNotePyramidIds().getMiddleNoteIds());
    assertEquals(
        perfume.getNotePyramidIds().getBaseNoteIds(),
        savedPerfume.getNotePyramidIds().getBaseNoteIds());
  }
}

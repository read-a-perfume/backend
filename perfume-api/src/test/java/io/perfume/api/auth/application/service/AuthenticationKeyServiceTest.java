...
class AuthenticationKeyServiceTest {
  ...
  StubAuthenticationKeyRepository authenticationKeyRepository =
      new StubAuthenticationKeyRepository();

  StubAuthenticationKeyQueryRepository authenticationKeyQueryRepository =
      new StubAuthenticationKeyQueryRepository();
  ...
  void testCheckEmailCertificate() {
    ...
    authenticationKeyQueryRepository.add(
        AuthenticationKey.createAuthenticationKey("code", "key", LocalDateTime.now()));
  ...
  void testCheckEmailCertificateWhenNotMatchedCode() {
    // given
    authenticationKeyQueryRepository.add(
        AuthenticationKey.createAuthenticationKey("edoc", "key", LocalDateTime.now()));
    CheckEmailCertificateCommand command =
        new CheckEmailCertificateCommand("key", "code", LocalDateTime.now());

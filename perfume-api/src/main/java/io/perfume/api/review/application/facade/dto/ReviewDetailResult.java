...
public record ReviewDetailResult(
    Long id, String shortReview, ReviewDetailUserResult user, List<String> tags) {

  public static ReviewDetailResult from(ReviewResult review, UserResult user, List<String> tags) {

...
public record UserTasteResult(Long id, String name, String thumbnail, String description) {
  ...
  static public UserTasteResult from(CategoryResult categoryResult) {
    return new UserTasteResult(categoryResult.id(), categoryResult.name(),
        categoryResult.thumbnail(), categoryResult.description());
  }
}

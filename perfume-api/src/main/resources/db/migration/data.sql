...
insert into brand (id, name, story, thumbnail_id, created_at, updated_at)
values (1, '조말론', '조말론은 18세기 영국에서 시작된 럭셔리 향수 브랜드입니다. 영국 왕실의 향수 제조사로 시작하여, 현재는 럭셔리 향수 브랜드로 자리잡고 있습니다.', 1, now(), now()),
       (2, '메종 마르지엘라', '메종 마르지엘라는 1988년 파리에서 설립된 프랑스 패션 하우스입니다. 특유의 미니멀한 디자인과 독특한 향기로 많은 사랑을 받고 있습니다.', 1, now(), now()),
       (3, '바이레도', '바이레도(Byredo)는 추억과 감정을 제품과 경험으로 옮기겠다는 야심으로 벤 고햄(Ben Gorham)이 2006년 스톡홀름에서 설립한 유럽 럭셔리 브랜드입니다.', 1, now(),
        now()),
       (4, '샤넬', '샤넬은 1910년 프랑스에서 시작된 럭셔리 패션 하우스이며, 향수 브랜드로도 유명하죠. 샤넬 No.5는 세계에서 가장 유명한 향수 중 하나입니다.', 1, now(), now()),
       (5, '톰 포드', '21세기 진정한 럭셔리 브랜드를 추구하는 톰 포드의 향수는 고급스럽고 독특한 향으로 유명하며, 세련된 디자인과 높은 품질로 유명합니다.', 1, now(), now()),
       (6, '버버리', '영국의 대표적인 패션 브랜드인 버버리는 1856년 영국에서 시작되었습니다. 버버리의 향수는 영국적 향취를 담아 특유의 럭셔리한 느낌을 선보입니다.', 1, now(), now()),
       (7, '프라다', '프라다는 1913년 이탈리아에서 시작된 패션 브랜드입니다. 프라다의 향수는 독특한 향기와 세련된 보틀 디자인으로 유명합니다.', 1, now(), now()),
       (8, '펜할리곤스', '영국 왕실이 사랑하는 펜할리곤스는 우리가 살고 있는 ‘현재’를 반영하는 브랜드입니다. 지금도 창의적 유산과 영국적 위트, 그리고 브랜드 철학이 그대로 이어지고 있습니다.', 1,
        now(), now()),
       (9, '프레쉬', '프레쉬는 1991년 미국에서 시작된 브랜드입니다. 프레쉬의 향수는 천연 원료를 사용하여 만들어지며, 특유의 청량한 느낌으로 유명합니다.', 1, now(), now()),
       (11, '마크 제이콥스','마크 제이콥스는 1984년 미국에서 시작된 패션 브랜드입니다. 특유의 밝고 젊은 분위기를 향수에 반영하여 ''데이지''를 비롯한 전세계 히트 향수 아이템을 선보이고 있습니다.', 1, now(),now()),
       (12, '산타마리아노벨라',
        '1221년 이탈리아 피렌체 수도원 정원에서 기원한 산타마리아노벨라는 800년 헤리티지를 계승하여 전통적인 생산 방식과 원료, 기술력을 결합하여 새로운 역사를 이어갑니다.', 1, now(), now()),
       ...
       (17, '에르메스',
        ...
        now(), now()),
       (18, '구딸 파리',
        '1945년 프랑스에서 탄생한 럭셔리 패션 브랜드로, 우아하고 세련된 디자인의 의류와 액세서리로 유명합니다. 오랜 전통과 프렌치 스타일을 현대적으로 재해석하여 세계적으로 사랑받고 있습니다.', 1,
        now(), now()),
       (19, '끌로에', '1950년대에 탄생한 프랑스의 패션 하우스로, 고급스러운 컬렉션과 아름다운 장인 정신으로 유명합니다. 화려하고 세련된 디자인으로 패션계를 선도하며, 세계적인 명성을 자랑합니다.', 1,
        now(), now()),
       (20, '미우미우',
        '1993년 이탈리아에서 시작된 패션 브랜드로, 전통적이면서도 현대적이고 대담한 디자인으로 유명합니다. 실험적이고 독창적인 스타일로 패션계에서 주목받고 있으며, 대중과 패션 열정가들에게 사랑을 받고 있습니다.', 1,
        now(), now()),
       (21, '디올',
        '1946년 프랑스에서 탄생한 럭셔리 패션 브랜드로, 고급스러운 의류, 액세서리, 향수 등으로 유명합니다. 전통과 현대성이 조화를 이룬 우아하고 세련된 디자인으로 세계적으로 인정받고 있으며, 뛰어난 크리에이티브로 유명합니다.', 1,
        now(), now()),
       (22, '돌체앤가바나',
        '1985년 이탈리아에서 시작된 패션 브랜드로, 화려하고 세련된 스타일의 의류와 액세서리로 유명합니다. 대담하고 화려한 패션으로 인기를 끌며, 전통적인 이탈리아 스타일을 현대적으로 표현합니다.', 1,
        now(), now()),
       (23, '불가리',
        '1884년 이탈리아에서 탄생한 주얼리 브랜드로, 고급스러운 보석과 액세서리로 유명합니다. 우아하고 현대적인 디자인으로 세계적으로 사랑받으며, 뛰어난 장인 정신과 품질로 손목 위의 예술을 선보입니다.', 1,
        now(), now()),
       (24, '러쉬',
        '1995년 영국에서 시작된 신선하고 자연 친화적인 화장품 브랜드로, 합리적인 가격과 천연 재료를 사용하여 제품을 생산합니다. 친환경적이고 창의적인 제품으로 소비자들에게 큰 사랑을 받고 있으며, 동물실험을 하지 않는 브랜드로도 유명합니다.', 1, now(), now()),
       (25, '데메테르', '1996년 미국에서 탄생한 브랜드로 주변에서 쉽게 볼 수 있는 자연이나 상황, 기분, 사물등을 향기로 나타내어 소중한 기억을 불러일으키는 향수를 만듭니다.', 1, now(), now()),
       (26, '겔랑',
        '겔랑은 세계에서 가장 오래된 프랑스 향수, 화장품, 스킨케어 브랜드입니다. 많은 전통적인 겔랑 향수는 "겔리나드"라고 알려진 공통 후각 조화를 특징으로 합니다. 이 하우스는 조향사 피에르 프랑수아 파스칼 겔랑(Pierre-François Pascal Guerlain)에 의해 1828년 파리에서 설립되었습니다.', 1, now(), now()),
       (27, '4711', '전통적인 독일 향수 브랜드로, 몸과 마음에 활력을 주는 상쾌한 향기로 유명합니다.', 1, now(), now()),
       (28, '랑방',
        '1958년 프랑스에서 시작된 전통적인 하이패션 브랜드로, 우아하고 클래식한 스타일의 의류와 액세서리로 유명합니다. 뛰어난 품질과 디자인으로 여성들에게 사랑을 받으며, 시대를 초월한 아름다움을 추구합니다.', 1,
        now(), now()),
       (29, '메종 프란시스 커정',
